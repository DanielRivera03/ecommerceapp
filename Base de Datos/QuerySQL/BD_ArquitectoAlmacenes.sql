...
SELECT DISTINCT Dui, IdUsuario FROM Ventas GROUP BY IdUsuario, Dui  

--select * from Ventas where IdUsuario=11
--update ventas set dui='00000000-1' where IdUsuario=1
GO
