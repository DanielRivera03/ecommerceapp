...
{
    public class ProblemasPlataforma
    {
        public int IdReportePlataforma { get; set; }
        public string NombreReporte { get; set; }
        public string DescripcionReporte { get; set; }
        public string RutaImagen { get; set; }
        public string NombreImagenReporte { get; set; }
        ...
        // REFERENCIA AL OBJETO ID DE USUARIO DE LA CLASE USUARIO
