...
namespace CapaEntidad
{
    ...
    {
        public int IdControlGarantias { get; set; }
        // REFERENCIA AL OBJETO ID MARCAS DE LA CLASE MARCAS DE PRODUCTOS
        public Marcas oMarcas { get; set; }
        public string Descripcion { get; set; } // NOMBRES DE MARCAS DE PRODUCTOS
        public int DuracionDiasGarantia { get; set; }
        public string DescripcionFabricanteGarantia { get; set; }
